...
add_action( 'shoper_store_archive_description', 'woocommerce_taxonomy_archive_description',10 );
add_action( 'shoper_store_archive_description', 'woocommerce_product_archive_description',10 );
/**
