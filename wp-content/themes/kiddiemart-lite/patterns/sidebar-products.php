...
<div class="wp-block-group wp-block-widget-area wp-block-sidebar">
	...
	<div class="wp-block-group wp-block-widget">
		...
		<h2 id="categories" style="margin-top:0px;margin-right:0px;margin-bottom:20px;margin-left:0px">
			<?php esc_html_e ( 'Categories', 'kiddiemart-lite' ); ?>
		</h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3>
				<?php esc_html_e ( 'Filter by price', 'kiddiemart-lite' ); ?>
			</h3>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget wp-filter-by-size">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3>
				<?php esc_html_e ( 'Filter by size', 'kiddiemart-lite' ); ?>
			</h3>
			<!-- /wp:heading -->
	...
	<div class="wp-block-group wp-block-widget wp-filter-by-color">
		...
		<div class="wp-block-woocommerce-filter-wrapper">
			<!-- wp:heading {"level":3} -->
			<h3>
				<?php esc_html_e ( 'Filter by Color', 'kiddiemart-lite' ); ?>
			</h3>
			<!-- /wp:heading -->
